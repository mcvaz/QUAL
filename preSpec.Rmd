...
# Hmax x LUE
plot(mm$Hmax[-c(1,2,55,84,101,104)],mm$LUEc[-c(1,2,55,84,101,104)],xlab="Hmax",ylab="LUE")
mod = lm(mm$LUEc[-c(1,2,55,84,101,104)]~mm$Hmax[-c(1,2,55,84,101,104)])
summary(mod)
#plot(mod)
...
text(33,1.2,expression(paste(R^2," = 0.04")),col=2)
